...
const courses = [
                    ...
                    syntax:
                        {
                            ...
                            code: "#Синтаксис: оператор екі аргументтің арасына жазылады. \\n10+3 #13 \\n10-3 #7 \\n10*3 #30 \\n10/3 #3.33 \\n10**3 #1000 \\n10//3 #3 \\n10%3 #1"
                        },
                },
                {
                    name: "Салыстыру операторлары",
                    description: "Python - дағы салыстыру операторлары операндтарды салыстырады. Олар аргументтердің біреуі екіншісінен үлкен, кішірек немесе тең екенін bool арқылы тексереді.",
                    syntax:
                        {
                    ...
                    syntax:
                        {
                            ...
                            code: "#Синтаксис: оператор басқа екі операторлық мәлімдемелердің арасына жазылады. \\na = 7 > 7 and 2 > -1 #False \\na = 7 > 7 or 2 > -1 #True \\na = not(0) #True"
                        },
                }
            ]
    },
    {
        ...
        syntax:
            {
                explanation:"Түсіндірме: if – шарт қою операторы. \\nelif(else if) – одан бұрынғы шарт орындалмаған жағдайда тағы бір шарт қоюға мүмкіндік беретін операторы. \\nelse – одан бұрын қойылған шарттардың ешқайсысы орындалмаған жағдайдағы іске қосылатын оператор. ",
                code:"a = 10 \\n#Синтаксис: оператордан кейін шарт қойылады және ең соңына екі нүкте (:), ал бұл блокқа кіретін операциялар оператор бағанынан бір бос орын қалдыру арқылы жазылады. Егер оның мәні «ақиқат» болса, онда бағдарлама осы жерден жалғасады. \\nif a == 5 + 7: #False  \\    nprint('First') \\n#Синтаксис: оператордан кейін шарт қойылады және ең соңына екі нүкте (:), ал бұл блокқа кіретін операциялар оператор бағанынан бір бос орын қалдыру арқылы жазылады. Егер одан бұрынғы шарттың мәні оның мәні «жалған», ал осы шарттың мәні  «ақиқат» болса, онда бағдарлама осы жерден жалғасады. \\nelif a == 10/2: #False  \\n    print('Second') #Синтаксис: оның саны алгоритмге тәуелді шексіз бола алады. \\nelif a == 10*2: #False \\n    print('Third') #Синтаксис: оператордан тек өзі жазылады және ең соңына екі нүкте (:), ал бұл блокқа кіретін операциялар оператор бағанынан бір бос орын қалдыру арқылы жазылады. Егер одан бұрынғы шарттардың мәндері «жалған» болса, онда бағдарлама осы жерден жалғасады. \\nelse: #True \\n    print('Fourth') \\n#Бағдарлама нәтижесінде 'Fourth' жазуы шығады, себебі тек төртінші шарттың нәтижесі орындалды"
            },
        tutorials: [
            {
                name:"if",
